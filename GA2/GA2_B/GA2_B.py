...
from PairwiseExchange import Exhange
from AntPheremone import Pher
from RandoTry import RandomTries
from RandobasedExchange import RandomExchange 
import random
...
def TestAlgo(Algo):
    ...
    for i in range(100):#for the average run amount of distance
        NR, Xs, Ys = RandomPoints(70) #calls up a function in the randompoints file to generate 90 unique points
...
Distance, Time = TestAlgo(RandomTries)#current algorithms are Pher, NearestNeighbour and RandomTries, they are the import files
